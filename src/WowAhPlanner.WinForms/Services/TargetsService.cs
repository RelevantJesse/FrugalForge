    ...
    IProducerRepository producerRepository)
{
        ...
        string realmSlug)
    {
        ...
        var lines = new List<string>
        {
            ...
            $"WowAhPlannerScan_TargetRegion = \"{EscapeLuaString(region.ToString())}\"",
            $"WowAhPlannerScan_TargetRealmSlug = \"{EscapeLuaString(realmSlug ?? "")}\"",
            ...
            $"WowAhPlannerScan_OwnedItemIds = {{ {string.Join(", ", ownedItemIds)} }}",
